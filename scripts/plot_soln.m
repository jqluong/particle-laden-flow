...
load(comparison_name) %load([comparison_name,'.mat'])
...
xlim([0 1.5*times_exp(end)])%axis([0 1.5*times_exp(end) 0 1.3*fronts_exp(end,1)]);
...
xlabel('$t^{1/3}$ (s)')
ylabel('cm')
xlim([0 1.5*times_exp_e(end)])%axis([0 1.5*times_exp(end) 0 1.3*fronts_exp(end,1)]);
hold off
